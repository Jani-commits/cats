...
contract KittyMarketPlace is Ownable {
    ...
    function getOffer(uint256 _tokenId)
       ...
       function setOffer(uint256 _price, uint256 _tokenId) public {
           ...
           require(tokenIdToOffer[_tokenId].active == false, "You cant sell twice the same offers");
           require(_kittyContract.isApprovedForAll(msg.sender, address(this)), "Contract needs to be approved to transfer");
